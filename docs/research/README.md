...
| CEL (Common Expression Language) | [cel-policy.md](cel-policy.md) | Whether CEL can express auth policy (allow user/group) as an advanced alternative to ADR-0002's typed allow-list. |
